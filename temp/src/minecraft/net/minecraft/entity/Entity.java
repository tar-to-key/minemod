...
public abstract class Entity {
   ...
   public void func_70091_d(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
      if(this.field_70145_X) {
         ...
         if(this.field_70170_p.func_147470_e(this.field_70121_D.func_72331_e(0.0010D, 0.0010D, 0.0010D))) {
            this.func_70081_e(1);
            if(!var41) {
               ++this.field_70151_c;
               if(this.field_70151_c == 0) {
   ...
   public boolean func_70072_I() {
      if(this.field_70170_p.func_72918_a(this.field_70121_D.func_72314_b(0.0D, -0.4000000059604645D, 0.0D).func_72331_e(0.0010D, 0.0010D, 0.0010D), Material.field_151586_h, this)) {
